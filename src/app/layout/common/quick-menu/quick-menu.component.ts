...
import { QuickMenuService } from 'app/layout/common/quick-menu/quick-menu.service';
...
export class QuickMenuComponent implements OnInit, OnDestroy
{
     ...
     */
     constructor(
        ...
        private _quickMenuService: QuickMenuService,
    ...
    selectMenu(id: string): void
    {
        ...
        // Get the menu data
        this._quickMenuService.getMenuById(id).subscribe();
    }
     ...
     */
     private _showOverlay(): void
     {
         ...
         this._overlay.classList.add('quick-menu-overlay');
