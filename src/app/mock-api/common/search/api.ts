...
import { cardData } from 'app/modules/publishers/components/publisher-list/publisher.model'
@Injectable({
    providedIn: 'root'
})
export class SearchMockApi
{
    ...
    private readonly _publisherData: any[] = cardData;
    ...
    registerHandlers(): void
    {
        ...
        this._fuseMockApiService
            ...
            .reply(({request}) => {
                ...
                // Filter the contacts
                const publishersResults = cloneDeep(this._publisherData).filter(contact => contact.publisher_name.toLowerCase().includes(query));
                ...
                if ( publishersResults.length > 0 )
                {
                    // Normalize the results
                    publishersResults.forEach((result) => {

                        // Add a link
                        result.link = 'master/publisher/list';
                    });
