...
import { stages, stagesData,  } from './stages.model';
...
export class StagesListComponent implements OnInit {
  ...
  public stagesData:stages[] = stagesData;
  ...
  obs: Observable<any>;
  inputData :any
  dataSource: MatTableDataSource<any> = new MatTableDataSource<any>(this.stagesData);
